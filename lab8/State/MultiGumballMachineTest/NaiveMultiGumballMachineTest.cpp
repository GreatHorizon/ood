...
std::string GetNaiveGumballMachineExpectedOut(std::string const& expectedInvertoryString,
...
BOOST_FIXTURE_TEST_SUITE(empty_gumball_machine_test, NaiveEmptyGumballMachine)
	...
	{
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("0 gumballs", "sold out", 0));
	}
...
BOOST_FIXTURE_TEST_SUITE(naive_multi_gumball_machine_test, NaiveGumballMachine)
	...
	{
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("5 gumballs", "waiting for quarter", 0));
	}
	...
	{
		machine.InsertQuarter();
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("5 gumballs", "waiting for turn of crank", 1));
		machine.InsertQuarter();
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("5 gumballs", "waiting for turn of crank", 2));
	}
	...
	BOOST_AUTO_TEST_CASE(cant_insert_more_than_5_quarters)
	{
		...
		machine.InsertQuarter();
		machine.InsertQuarter();
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("5 gumballs", "waiting for turn of crank", 5));
		machine.InsertQuarter();
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("5 gumballs", "waiting for turn of crank", 5));
	}
	...
	BOOST_AUTO_TEST_CASE(can_return_quarters_in_soldout_state)
	{
		...
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("0 gumballs", "sold out", 2));
		machine.EjectQuarter();
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("0 gumballs", "sold out", 0));
	}
	...
	BOOST_AUTO_TEST_CASE(state_should_became_no_quarters_when_use_last_quarter)
	{
		machine.InsertQuarter();
		machine.TurnCrank();
		BOOST_CHECK_EQUAL(machine.ToString(), GetNaiveGumballMachineExpectedOut("4 gumballs", "waiting for quarter", 0));
	}
BOOST_AUTO_TEST_SUITE_END()
